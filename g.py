...
TOKEN = '7496156309:AAGlw27T6J1PjT7ZgpwRzU06NL6CiFA_SZY'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1008049
CHANNEL_ID = -1008049
error_channel_id = -1008049
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*𝐔𝐑 𝐍𝐎𝐓 𝐀𝐏𝐏𝐎𝐑𝐕𝐄𝐃 😂 𝐃𝐦 @SILENTXOP*", parse_mode='Markdown')
...
def attack_command(message):
    ...
    try:
        bot.send_message(chat_id, "𝗘ηтεя ᎥᎮ 𝗣σят 𝐓ɪᴍᴇ {𝐢𝐧 𝐬𝐞𝐜𝐨𝐧𝐝𝐬👽 𝐒𝐞𝐩𝐚𝐫𝐚𝐭𝐞𝐝 𝐛𝐲 𝐬𝐩𝐚𝐜𝐞 .*", parse_mode='Markdown')
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*𝐅𝐔𝐂𝐊𝐄𝐃 𝐔𝐏 💥\n\n𝔥𝔬𝔰𝔱: {target_ip}\n𝔭𝔬𝔯𝔱: {target_port}\n𝔱𝔦𝔪𝔢: {duration} seconds*", parse_mode='Markdown')
    except Exception as e:
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/infintysetup/167*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*𝐁𝐨𝐭 𝐟𝐚𝐭𝐡𝐞𝐫 @SILENTXOP 🗿*", parse_mode='Markdown')
    else:
